 ...
 */
/**
 * Response containing pipeline observability data grouped by tables
 */
export interface PipelineObservabilityResponse {
    ...
    pipelineFqn: string;
    /**
     * Pipeline ID for which observability data is requested
     */
    pipelineId: string;
    /**
...
/**
 * Observability data for a specific table related to the pipeline
 */
export interface TableObservabilityData {
    /**
     * Pipeline observability data entries for this table
     */
    observabilityData: PipelineObservability[];
    /**
