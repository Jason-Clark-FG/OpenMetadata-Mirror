 ...
 */
/**
 * Schema for bulk updating multiple dashboards with differential updates
 */
export interface BulkUpdateDashboard {
    /**
     * If true, validate without persisting
     */
    dryRun?: boolean;
    /**
     * List of dashboard update requests
     */
    updates: DashboardUpdate[];
}

/**
 * Partial dashboard update - only include fields that have changed
 */
export interface DashboardUpdate {
    /**
     * Updated charts in the dashboard
     */
    charts?: EntityReference[];
    /**
     * Updated dashboard type
     */
    ...
    extension?: any;
    /**
     * Fully qualified name of the dashboard to update
     */
    fqn: string;
    /**
     * Updated owner
