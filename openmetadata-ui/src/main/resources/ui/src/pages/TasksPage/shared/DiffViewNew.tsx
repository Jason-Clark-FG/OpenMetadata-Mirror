  ...
  useEffect(() => {
    const checkHeight = () => {
      if (contentRef.current) {
        ...
        (contentRef.current.style as unknown as Record<string, string>)['-webkit-line-clamp'] = 'none';
        ...
        // Reset the styles
        (contentRef.current.style as unknown as Record<string, string>)['-webkit-line-clamp'] = '';
