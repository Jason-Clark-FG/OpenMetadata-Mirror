...
from tests.utils.factoryboy.polymorphic_subfactory import PolymorphicSubFactory
from tests.utils.factoryboy.root_model import RootModelFactory, RootSubFactory
...
class PatternRecognizerFactory(factory.Factory):
    type = "pattern"
    patterns = factory.LazyFunction(lambda: [PatternFactory.create()])
