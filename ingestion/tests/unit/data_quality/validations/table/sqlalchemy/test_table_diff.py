...
from metadata.utils.matchers import HasProperties, Matcher, MatchesRegex
        ...
        (
            (
                ...
                HasProperties(
                    ...
                    result=MatchesRegex("Removed columns: last_name")
                    & MatchesRegex("Added columns: first_name")
                    - MatchesRegex("Changed"),
                ),
            ),
            (
                build_table_parameter(
            ...
            (
                ...
                HasProperties(
                    testCaseStatus=TestCaseStatus.Failed,
                    result=MatchesRegex("Removed columns: last_name")
                    & MatchesRegex("Added columns: table_id, first_name")
                    - MatchesRegex("Changed"),
                ),
            ),
        ),
