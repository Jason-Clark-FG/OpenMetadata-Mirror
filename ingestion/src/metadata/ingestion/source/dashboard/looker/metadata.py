...
class LookerSource(DashboardServiceSource):
    ...
    def __init__(
        ...
        self._pending_explores: List[str] = []  # noqa: UP006
        self._pending_views: List[Tuple[str, str]] = []  # noqa: UP006
        self._processed_view_names: Set[str] = set()  # noqa: UP006
        self._pending_view_lineage: List[Tuple[LookMlView, LookmlModelExplore, str]] = []  # noqa: UP006
        self._pending_standalone_lineage: List[Tuple[LookMlView, str, str, str]] = []  # noqa: UP006
